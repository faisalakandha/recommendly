        ...
        <script>
            ...
            $("document").ready(function() {
                ...
                $("#apiSubmit").click(function() {
                    ...
                    postData(data, siteUrl + '/wp-json/recommendly/v1/saveapikey');
                });
                ...
                $("#cilfap").click(function() {
                    ...
                    postData(king, siteUrl + '/wp-json/recommendly/v1/createinternallinksforallposts');
                ...
                $("#rilfap").click(function() {
                    ...
                    postData(wim, siteUrl + '/wp-json/recommendly/v1/removeinternallinks');
                });
                ...
                $("#cfnu").click(function() {
                    ...
                    postData(wer, siteUrl + '/wp-json/recommendly/v1/updates');
                });
                ...
                $("#enable").click(function() {
                    ...
                    postData(eData, siteUrl + '/wp-json/recommendly/v1/cronoption');
                });
